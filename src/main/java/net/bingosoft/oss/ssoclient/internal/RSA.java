...
public class RSA {
    ...
    public static RSAPrivateKey decodePrivateKey(String base64){
        PKCS8EncodedKeySpec spec = new PKCS8EncodedKeySpec(java.util.Base64.getMimeDecoder().decode(base64));
        try {
    ...
    public static RSAPublicKey decodePublicKey(String base64){
        X509EncodedKeySpec spec = new X509EncodedKeySpec(java.util.Base64.getMimeDecoder().decode(base64));
        try {
